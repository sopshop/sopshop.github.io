                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="space-y-3">
                      ...
                      {!preview && (
                        <div className="flex items-center justify-center rounded-xl border-2 border-dashed border-border bg-muted/40 aspect-video">
                          <div className="text-center text-muted-foreground">
                            <ImagePlus className="h-8 w-8 mx-auto mb-2 opacity-40" />
                            <p className="text-xs">Paste an image URL below</p>
                          </div>
                        </div>
                      )}
                      <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Describe the item, condition, sizing..."
                      rows={4}
                      {...field}
